...
public class userRegistration extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel4)
                    .addComponent(userAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(24, 24, 24)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public void autoID() {
        try {
            ...
            ResultSet rs;
            rs = s.executeQuery("select (substring(Pid,3,8)) as pid from Passenger;");
            rs.next();
            rs.getString("pid");
            if (rs.getString("pid")==null) {
                userId.setText("VN10000000");
            } else {
                ...
                while(true) {
                    ...
                    while(rs.next()) {
                        int sampleId= Integer.parseInt(rs.getString("pid"));
                        if (id == sampleId) {
                            dupCheck=true;
                            break;
                        }
                ...
                userId.setText("VN"+ String.valueOf(id));
